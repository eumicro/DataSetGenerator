...
class PascalVocReader:
    ...
    def getShapes(self,filePath=None):
        return self._parseXML(filePath)

    def _parseXML(self,filepath):
        shapes = []
        ...
        for object_iter in xmltree.findall('object'):
            ...
            shapes.append((label, points, None, None, difficult,filename))
        return shapes
